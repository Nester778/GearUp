            ...
            <div className={`myOrdersCard-content ${open ? 'open' : ''}`}>
                ...
                <div className="myOrdersCard-content-work">
                    ...
                    <div className="myOrdersCard-content-btn">
                        <div className="content-btn-cancel" onClick={hendlBtnCancel}>
                            <p>Відхилити</p>
                        </div>
                        <div className="content-btn" onClick={hendlBtn}>
                            <p>Почати роботу</p>
                        </div>
                        <div className="content-btn-finish" onClick={hendlBtnFinish}>
                            <p>Завершити роботу</p>
                        </div>
                    </div>
                </div>
